...
//';
			...
			if ( $is_nextgen_active ) {
				if ( self::is_option_checked( $fbx_options, 'enable_nextgenV2', true ) ) {
					$foobox_selectors[] = '.ngg-galleryoverview, .ngg-widget, .nextgen_pro_blog_gallery, .nextgen_pro_thumbnail_grid, [id^=\'ngg-gallery-\']';
...
//				} else {
					...
					$social_icons[] = "{ css: 'fbx-tumblr', title: 'Tumblr', url: 'https://www.tumblr.com/widgets/share/tool?canonicalUrl={url}&content={img}&title={title}&caption={desc}' {$social_title_json} }";
