var svgIconConfig = {
	clock : { 
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/clock.svg',
		animation : [
			{ 
				el : 'path:nth-child(2)', 
				animProperties : { 
	...
	trash : { 
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/trash.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	contract : { 
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/contract.svg',
		animation : [
			{ 
				el : 'rect:nth-child(2)', 
				animProperties : { 
	...
	maximize : { 
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/maximize.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	volume : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/volume.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	plus : { 
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/plus.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	hamburger : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/hamburger.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	navLeftArrow : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/nav-left-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	navUpArrow : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/nav-up-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	rightArrow : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/right-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	downArrow : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/down-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	smiley : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/smiley.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	play : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/play.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	mail : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/mail.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	equalizer : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/equalizer.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	glass : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/glass.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	hourglass : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/hourglass.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	padlock : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/padlock.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	zoom : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/zoom.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	monitor : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/monitor.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	flag : {
		url : 'wp-content/themes/gtma-theme/assets/img/svg-icons/svg/flag.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
